...
const RESOURCE_PRODUCTION: { [country: string]: { oil: number; steel: number; food: number } } = {
  // Major Oil Producers
  "usa": { oil: 20, steel: 15, food: 18 },
  "آمریکا": { oil: 20, steel: 15, food: 18 },
  "saudi arabia": { oil: 10.9, steel: 3, food: 2 },
  "عربستان سعودی": { oil: 10.9, steel: 3, food: 2 },
  "عربستان": { oil: 10.9, steel: 3, food: 2 },
  "russia": { oil: 10.8, steel: 12, food: 10 },
  "روسیه": { oil: 10.8, steel: 12, food: 10 },
  "canada": { oil: 5.9, steel: 8, food: 12 },
  "کانادا": { oil: 5.9, steel: 8, food: 12 },
  "china": { oil: 4.3, steel: 20, food: 15 },
  "چین": { oil: 4.3, steel: 20, food: 15 },
  "iran": { oil: 5.1, steel: 4, food: 6 },
  "ایران": { oil: 5.1, steel: 4, food: 6 },
  "iraq": { oil: 4.4, steel: 1, food: 3 },
  "عراق": { oil: 4.4, steel: 1, food: 3 },
  "uae": { oil: 4, steel: 2, food: 1 },
  "امارات": { oil: 4, steel: 2, food: 1 },
  "brazil": { oil: 3.5, steel: 10, food: 14 },
  "برزیل": { oil: 3.5, steel: 10, food: 14 },
  "kuwait": { oil: 2.7, steel: 1, food: 1 },
  "کویت": { oil: 2.7, steel: 1, food: 1 },
